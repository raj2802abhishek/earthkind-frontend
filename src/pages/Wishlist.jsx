  ...
  return (
    <div className="wishlist-page-container">
        ...
        wishlist.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* IMAGE */}
              <div
                className="wishlist-item-img-wrapper"
                style={{
                  width: "180px",
                  height: "180px",
                  background: "#f9f9f9",
      ...
      <div style={{ marginTop: "70px" }}>
        ...
        {/* Desktop Space-Between Arrows Above Cards */}
        <div
          className="wishlist-desktop-arrows"
          style={{
            display: "flex",
        ...
        >
          <button onClick={scrollLeft} style={arrowButton}>
            <FiChevronLeft />
          </button>
          <button onClick={scrollRight} style={arrowButton}>
            <FiChevronRight />
          </button>
        </div>

        {/* Carousel Container with Mobile Side-Centered Arrows */}
        <div
          className="wishlist-carousel-wrapper"
          style={{
            position: "relative"
          }}
        >
          <button
            onClick={scrollLeft}
            className="wishlist-arrow-left mobile-only-arrow"
            style={{
              ...arrowButton,
              position: "absolute",
              left: "-6px",
          ...
          <button
            onClick={scrollRight}
            className="wishlist-arrow-right mobile-only-arrow"
            style={{
              ...arrowButton,
              position: "absolute",
              right: "-6px",
