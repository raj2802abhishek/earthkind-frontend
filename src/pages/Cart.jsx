            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* ALL WEIGHTS */}
                  <div className="cart-weights-container">
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              <button
                                onClick={() =>
                                  decreaseQuantity(originalIndex)
                                }
                                style={{
                                  width: "30px",
                                  height: "30px",
                                ...
                                onMouseEnter={(e) => {
                                  e.currentTarget.style.background = "#123524";
                                  e.currentTarget.style.color = "#fff";
                                  e.currentTarget.style.transform = "translateY(-2px)";
                                }}
                                onMouseLeave={(e) => {
                                  e.currentTarget.style.background = "#fff";
                                  e.currentTarget.style.color = "#123524";
                              ...
                              <button
                                onClick={() =>
                                  increaseQuantity(originalIndex)
                                }
                                style={{
                                  width: "30px",
                                  height: "30px",
